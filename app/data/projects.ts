export const projectData = [
    ...
    { 
        id: "send-me-to-school",
        label: "SMS", 
        title: "Send Me to School", 
    ...
    { 
        ...
        label: "ICD", 
        title: "Intellectual Capacity", 
        desc: "Developing analytical and academic abilities for future leaders.", 
        image: "/ttn/i28.jpeg", 
        category: "Education",
        longDesc: "Our Intellectual Capacity Development (ICD) program focuses on leadership, critical thinking, and English language proficiency to prepare youth for global opportunities.",
        impact: ["Weekly debate sessions", "English proficiency certification", "Leadership workshops"]
    },
    { 
        id: "finance-access",
        label: "FAB", 
        title: "Finance Access for Women", 
        desc: "Empowering women entrepreneurs with business resources.", 
        image: "/ttn/i24.jpeg", 
        category: "Empowerment",
        longDesc: "FAB provides micro-loans and business training to women in our communities, enabling them to start and grow small businesses that support their families.",
        impact: ["50+ Women empowered", "Small business training", "Financial independence"]
    }
];
